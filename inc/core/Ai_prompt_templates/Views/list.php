...
<div class="container d-sm-flex align-items-md-center pt-4 align-items-center justify-content-center">
    <div class="bd-search position-relative me-auto">
        <h2 class="mb-0 py-4 text-gray-800 d-flex align-items-center"> <div class="border rounded h-40 w-40 fs-18 d-flex align-items-center justify-content-center text-dark b-r-10 me-3" style="background-color: <?php _ec( get_data($category, "color") )?>"><i class="<?php _ec( get_data($category, "icon") )?>"></i></div> <?php _e($category->name)?></h2>
    </div>
    <div class="">
        <div class="dropdown me-2">
            <div class="input-group input-group-sm sp-input-group border b-r-4">
                ...
                <a href="<?php _ec( get_module_url("popup_add_prompt/".$category->ids) )?>" class="btn btn-light btn-active-light-primary m-r-1 border-end actionItem" title="<?php _e("Add new")?>" data-toggle="tooltip" data-placement="top" data-popup="addPromptTemplate"><i class="fad fa-plus text-primary pe-0"></i></a>
                <a href="<?php _e( get_module_url('delete_prompt/'.$category->ids) )?>" class="btn btn-light btn-active-light-danger actionMultiItem" data-confirm="<?php _e('Are you sure to delete this items?')?>" data-remove-other-active="true" data-active="bg-light-danger" data-result="html" data-content="main-wrapper" data-redirect="<?php _ec( current_url() )?>" title="<?php _e("Delete")?>" data-toggle="tooltip" data-placement="top"><i class="fad fa-trash-alt text-danger pe-0"></i></a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="<?php _e( get_data($datatable, "responsive")? "table-responsive":"" )?>">
                    ...
                    <?php if ( is_array( get_data($datatable, "columns") ) ): ?>
                        ...
                        <table 
                            ...
                            data-url="<?php _ec( get_module_url("ajax_list/".$category->ids) )?>" 
