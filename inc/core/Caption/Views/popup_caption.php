<div class="popup-caption bg-white d-flex flex-column flex-row-auto h-100" data-id="<?php _ec($name)?>">
	...
	<div class="card-body p-20 position-relative ajax-load-scroll-1 overflow-auto" data-url="<?php _ec( get_module_url("load_captions") )?>" data-scroll="ajax-load-scroll-1">
